export const updateHeighestMarksAndAverageMarks = () => {
    return async (context) => {
      ...
      const maxmarksstudentrecord=await studentTestResultService.find({query: {
      ...
      await testService.patch(testId, { highestMarks: maxmarksstudentrecord.data[0].obtainedMarks},{ new: true })
