...
export  default function () {
  return async (context) => {
    context.data={
      ...
      throw new Error({ message: "Invalid email id" });
    ...
    context.data.message='<b>Your temporary password to login RCMS is  </b>'+tempoaryPassword+'<b> USe this password to login and set new password </b>'
